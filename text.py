...
#     pkgs = ['pywinauto', 'pywin32', 'comtypes', 'pyautogui', 'Pillow']
...
# # --- 2. HELPER FUNCTION ---
# def run_step(action, key, wait=1, shot=None):
#     """Executes a GUI action, waits, and optionally takes a screenshot."""
#     if action == 'press': pyautogui.press(key)
#     elif action == 'write': pyautogui.write(key)
...
# # --- 3. EXECUTION ---
# run_step(None, None, wait=0, shot="01_after_install.png") # Initial screenshot

# # Launch App
# exe_path = os.path.abspath("install-3.exe")
# if not os.path.exists(exe_path): sys.exit(f"Not found: {exe_path}")

# print(f"Launching: {exe_path}")
# subprocess.Popen(exe_path, shell=True)
# run_step(None, None, wait=10, shot="10_after_launching_second.png")

# # Automation Sequence: (Action, Key/Text, WaitTime, ScreenshotName)
# steps = [
#     ('press', 'tab', 1, None),
#     ('press', 'up', 1, None),
#     ('press', 'enter', 1, None),
#     ('press', 'enter', 1, None),
#     ('press', 'enter', 10, "11a_after_finishing_second.png"),
#     ('press', 'tab', 1, None),
#     ('press', 'space', 1, None),
#     ('press', 'enter', 10, None),
#     ('press', 'right', 1, "11b_after_finishing_second.png"),
#     ('press', 'right', 1, "11c_after_finishing_second.png"),
#     ('press', 'tab', 1, "11d_after_finishing_second.png"),
#     ('press', 'space', 1, "11e_after_finishing_second.png"),
#     ('press', 'tab', 1, "11f_after_finishing_second.png"),
#     ('write', 'text', 1, None),
#     ('press', 'tab', 1, "11_after_finishing_second.png")
# ]
